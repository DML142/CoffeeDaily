      ...
      <nav className="flex flex-col gap-4">
        {LINKS.map((link) => (
          <Link
            key={link.href}
            href={link.href}
            className="text-body-l transition-colors duration-200 hover:text-cd-orange"
        ...
        <Link
          href="/locations"
          className="mt-4 border border-cd-ink px-4 py-2 text-center text-body-s transition-colors duration-200 hover:bg-cd-ink hover:text-cd-cream"
          onClick={() => setMobileNavOpen(false)}
        >
