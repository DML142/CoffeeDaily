      ...
      {STORY_SECTIONS.map((section) => (
        ...
        >
          <Reveal className="container grid w-full flex-1 grid-cols-1 grid-rows-[1fr] gap-12 md:grid-cols-2">
            <div
              className={`relative overflow-hidden rounded-lg bg-cd-paper-warm ${section.imageFirst ? "" : "md:order-2"}`}
            >
              <Image
                src={section.image}
                alt={section.title}
            ...
            <div
              className={`flex flex-col justify-center ${section.imageFirst ? "" : "md:order-1"}`}
            >
